...
namespace MTCG
{
    static class Helper
    {
        ...
        public static string[] ExtractCardIds(string request) 
        {
            string[] stringSeparators = new string[] { "[\"", "\", \"", "\"]" };
            return request.Substring(request.IndexOf('[')).Split(stringSeparators, StringSplitOptions.RemoveEmptyEntries); 
